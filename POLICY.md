...
worker a coherent end-to-end phase bundle and let it own repository discovery,
...
A delegated child executes its assigned brief; it must not load the orchestration
