...
Read the supplied brief and relevant repository instructions. Check the assigned
working directory, writable paths, dependency outputs, contracts, and acceptance
criteria before editing. Do not assume uncommitted changes exist in another
worktree. A missing contract or contradictory requirement is a blocker to report,
...
checks, diagnose failures, and iterate within scope. A long assignment is allowed;
unbounded adjacent work is not. Keep a brief checkpoint for an interrupted run.
