...
The default is one native worker child in the current workspace for one coherent
...
Parallelism is opt-in per plan. Use at most two workers by default, and only
